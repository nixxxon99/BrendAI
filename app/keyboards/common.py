...
MAIN_KB = kb("🔎 🔎 Каталог брендов брендов", "🧠 Тренажёр знаний", "📊 Моя статистика", width=2)
ADMIN_MAIN_KB = kb("🔎 🔎 Каталог брендов брендов", "🧠 Тренажёр знаний", "📊 Моя статистика", "👑 Админ-панель", width=2)
