...
# Backward compatibility for older routers expecting _kb_find
def _kb_find(needle: str, top_n: int = 15):
    return suggest_candidates(needle, top_n=top_n)


# Backward compatibility for old routers expecting fuzzy_suggest
def fuzzy_suggest(needle: str, top_n: int = 15):
    return suggest_candidates(needle, top_n=top_n)
