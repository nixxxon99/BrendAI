...
async def on_startup(app: web.Application):
    if not WEBHOOK_URL:
        raise RuntimeError("WEBHOOK_URL пуст. Нужен публичный URL Web Service, напр. https://<name>.onrender.com")
...
def create_app() -> web.Application:
    ...
    # Обработчик вебхука (проверяет X-Telegram-Bot-Api-Secret-Token)
    ...
    # Подготовка приложения: фоновые таски и т.п.
